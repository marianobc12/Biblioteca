...
<div class="container-fluid">
    <div class="row">
        <div class="contenedor-tabla-devoluciones col-md-10 col-md-offset-1 col-sm-12">
            <h1>Devoluciones</h1>
            <table id="Tabla-Devoluciones" class="table  table-striped table-bordered display responsive nowrap tabla-devoluciones" style="width:100%">
                <thead>
                    <tr>
                        <th>Nº Inventario</th>
                        <th>Libro</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['Fecha_Prestamo'].' Hasta '.$row['Fecha_Fin_Prestamo']; ?></td>
